...
def SendFallMessage(phone_number:str, name:str,ext:str="")->dict:
    """
    ...
    try:
        ...
        # print(e)
        log_sms.error("HTTPError:{}".format(e))
        return e
    except Exception as e:
        # print(e)
        log_sms.error("UnkownError:{}".format(e))
        return e
    print(result)
    try:
        if result["result"] == 0:
