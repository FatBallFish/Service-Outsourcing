...
def Initialize(main_path:str):
    ...
    try:
        ...
        r_pass = settings.REDIS_PASS
        global r_imgsetname, r_smssetname
        r_imgsetname = settings.REDIS_IMG_SETNAME  # TODO global setname
        r_smssetname = settings.REDIS_SMS_SETNAME
